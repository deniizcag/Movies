    ...
    func getMovies(category: MovieFilter) {
        ...
        NetworkManager.shared.getMovies(category: category) {[weak self] (result) in
            ...
            case .failure(let error):
                self.presentMovAlertOnTheMainThread(title: "Error", message: error.rawValue, buttonTitle: "Ok")
...
extension MoviesVC: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let destVC = MovieDetailVC(movie: movie)
...
extension MoviesVC: HeaderViewCellDelegate {
